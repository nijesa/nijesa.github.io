...
export default function Ejemplo() {
	return (
		<div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--bg)' }}>
			{/* Phone-sized card */}
			<div className="w-[360px] max-w-full h-[780px] sm:h-auto rounded-3xl shadow-lg p-6 flex flex-col items-center theme-card">
				<div className="w-full flex-1 flex flex-col items-center justify-start pt-6">
					...
					<form className="w-full px-6 mt-6 space-y-4" onSubmit={(e)=>e.preventDefault()}>
						<input
							aria-label="Correo"
							placeholder="Correo..."
							className="w-full input-accent placeholder-accent rounded-xl py-3 px-4 focus:outline-none focus:ring-2 focus:ring-green-300"
						/>
